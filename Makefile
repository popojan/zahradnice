...
zahradnice-speed:
	g++ -std=c++20 -lz -lncursesw -lSDL2_mixer src/zahradnice.cpp src/grammar.cpp src/sample.cpp src/statusline.cpp -o zahradnice -O3 -s

zahradnice-debug:
	g++ -std=c++20 -lz -lncursesw -lSDL2_mixer src/zahradnice.cpp src/grammar.cpp src/sample.cpp src/statusline.cpp -o zahradnice -O2 -g

zahradnice-size:
	g++ -std=c++20 -lz -lncursesw -lSDL2_mixer src/zahradnice.cpp src/grammar.cpp src/sample.cpp src/statusline.cpp -o zahradnice -Os -s \
